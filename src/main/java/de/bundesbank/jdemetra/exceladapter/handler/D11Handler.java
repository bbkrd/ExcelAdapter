...
public class D11Handler implements IHandler {
    ...
    public Pair<String, List<Ts>> extractData(String multidocName, List<SaItem> items) {
        ...
        return Pair.of(multidocName + "-D11", list);

    }

    @Override
    public boolean isEnabled() {
        return NbPreferences.forModule(ExcelAdapterOptionsPanelController.class).getBoolean(ExcelAdapterOptionsPanelController.D11, true);
    }
}
